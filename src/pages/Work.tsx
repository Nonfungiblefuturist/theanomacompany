      ...
      <div className="max-w-7xl mx-auto px-5 md:px-10">
        ...
        <ScrollReveal type="fade-up" delay={0.1}>
          <p className="mt-4 text-muted-foreground text-lg max-w-2xl">
            AI tools, brand systems, and cinematic production. Every project is built to make an impact.
          </p>
        </ScrollReveal>
        <p className="mt-12 text-muted-foreground">Full project grid coming in Phase 2.</p>
      </div>
    </section>
    <CTABand />
    <Footer />
