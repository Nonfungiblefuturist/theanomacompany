      ...
      <section className="min-h-screen flex items-center justify-center px-6 pt-16 relative">
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8 relative z-10">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light leading-tight tracking-tight">
            Crafting the Future of Ads &<br />
            Film Visuals with AI
          </h1>
          
          <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            With AI, The Anoma Company accelerates the creative process, providing innovative solutions that keep projects ahead of schedule.
          </p>
